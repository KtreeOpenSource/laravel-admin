...
class UserFormTest extends TestCase
{
    ...
    public function testCreatePage()
    {
        $this->visit('admin/users/create')
            ...
            ->seeElement('hr')
            ->seeElement("input[type=text][name='profile[firstName]']")
            ->seeElement("input[type=text][name='profile[lastName]']")
    ...
    public function testSubmitForm()
    {
        ...
        $this->visit('admin/users/create')
            ...
            ->seeInElement('td', "{$data['profile']['firstName']} {$data['profile']['lastName']}")
            ->seeElement('td img')
        ...
        $this->seeInDatabase('test_user_profiles', ['firstName' => $data['profile']['firstName']]);
        $this->seeInDatabase('test_user_profiles', ['lastName' => $data['profile']['lastName']]);
    ...
    public function testEditForm()
    {
        ...
        $this->visit("admin/users/$id/edit")
            ...
            ->seeElement('hr')
            ->seeElement("input[type=text][name='profile[firstName]'][value='{$user->profile->firstName}']")
            ->seeElement("input[type=text][name='profile[lastName]'][value='{$user->profile->lastName}']")
